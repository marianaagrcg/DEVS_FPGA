...
module top_level (
    ...
    input wire clk,                
    input wire rst,                
    input wire [`WIDTH_PORT-1:0] x_in_tb, // External input from the testbench

    // Outputs to Testbench
    output wire [`WIDTH_PORT-1:0] y_out_tb,   // Output to the testbench
    output wire [`WIDTH_TIME-1:0] done_out_tb // "done" signal to the testbench
);

    // Wires for internal connections between modules
    ...
    // Connect outputs to testbench for observation
