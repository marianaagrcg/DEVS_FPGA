...
#set_property -dict { IOSTANDARD LVCMOS33 } [get_ports { BCDin[*] }];
#set_property -dict { IOSTANDARD LVCMOS33 } [get_ports { digit[*] }];
#set_property -dict { IOSTANDARD LVCMOS33 } [get_ports { Seven_Seg[*] }];

# Switches
set_property -dict { PACKAGE_PIN L5     IOSTANDARD LVCMOS33} [get_ports { BCDin[0] }];#LSB
set_property -dict { PACKAGE_PIN L4     IOSTANDARD LVCMOS33} [get_ports { BCDin[1] }];
set_property -dict { PACKAGE_PIN M4     IOSTANDARD LVCMOS33} [get_ports { BCDin[2] }];
set_property -dict { PACKAGE_PIN M2     IOSTANDARD LVCMOS33} [get_ports { BCDin[3] }];
...
set_property -dict { PACKAGE_PIN G2     IOSTANDARD LVCMOS33 } [get_ports {Seven_Segment[7]}];#A
set_property -dict { PACKAGE_PIN G1     IOSTANDARD LVCMOS33 } [get_ports {Seven_Segment[6]}];#B
set_property -dict { PACKAGE_PIN H5     IOSTANDARD LVCMOS33 } [get_ports {Seven_Segment[5]}];#C
set_property -dict { PACKAGE_PIN H4     IOSTANDARD LVCMOS33 } [get_ports {Seven_Segment[4]}];#D
set_property -dict { PACKAGE_PIN J5     IOSTANDARD LVCMOS33 } [get_ports {Seven_Segment[3]}];#E
set_property -dict { PACKAGE_PIN J4     IOSTANDARD LVCMOS33 } [get_ports {Seven_Segment[2]}];#F
set_property -dict { PACKAGE_PIN H2     IOSTANDARD LVCMOS33 } [get_ports {Seven_Segment[1]}];#G
set_property -dict { PACKAGE_PIN H1     IOSTANDARD LVCMOS33 } [get_ports {Seven_Segment[0]}];#DP
